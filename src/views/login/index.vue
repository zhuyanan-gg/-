...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { min: 6, max: 15, trigger: 'blur', message: '密码的长度应该在6-15个字符之间' }]
      },
      loading: false,
  ...
  mounted() {
    // this.$store.dispatch('user/response', this.loginForm)
  },
  methods: {
...
.login-container {
  // 在css里面路径出现@记得在前面加~
  background-image: url('~@/assets/common/szxy.jpg'); // 设置背景图片
